...
export default function BlogPostPage({ params }: { params: Params }) {
    const { slug } = params
    const { name, description, content } = CONFIG.projects[slug]
